...
def find_anki_collection_media() -> Path | None:
    ...
    if os.name == "nt":  # Windows
        ...
        if appdata:
            possible_paths.append(Path(appdata) / "Anki2" / "User 1" / "collection.media")
    else:  # macOS and Linux
        home = Path.home()
        possible_paths.extend([
            home / ".local" / "share" / "Anki2" / "User 1" / "collection.media",  # Linux
            home / "Library" / "Application Support" / "Anki2" / "User 1" / "collection.media",  # macOS
            home / "Documents" / "Anki2" / "User 1" / "collection.media",  # Alternative
        ])
